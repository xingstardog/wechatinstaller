...
void main() {
    ...
    textureCoordinateAlpha = vec2((textureTransform * vec4(vTexCoordinate.x + offset, vTexCoordinate.y, vTexCoordinate.z, vTexCoordinate.w)).x, (textureTransform * vTexCoordinate).y);
}
